function getCountry(name) {
  document.getElementById("totalVaccinationCountry").innerHTML =
    "Hold Tight...";
  document.getElementById("totalDeathCountry").innerHTML = "Hold Tight...";
  document.getElementById("totalCasesCountry").innerHTML = "Hold Tight...";
  ...
  fetch(`https://datatech-techta.herokuapp.com/data/${name}/${last30DaysStr}/${currentDateStr}`)
    .then(function (res) {
      return res.json();
    })
    .then((obj) => {
  ...
  xhttp.open(
    "GET",
    `https://datatech-techta.herokuapp.com/data/${name}/${last30DaysStr}/${currentDateStr}`
  );
  xhttp.send();
}
