...
fetch('https://datatech-techta.herokuapp.com/data/continents').then(function (res) {
    return res.json();
}).then(obj => {
...
xhttp_continent.open('GET', 'https://datatech-techta.herokuapp.com/data/continents');
