...
fetch('https://datatech-techta.herokuapp.com/data/top5').then(function (res) {
    return res.json();
}).then(obj => {
...
fetch('https://datatech-techta.herokuapp.com/data/global').then(function (res) {
    return res.json();
}).then(obj => {
    //retireve data from server
...
xhttp_global.open('GET', 'https://datatech-techta.herokuapp.com/data/global');
xhttp_global.send();